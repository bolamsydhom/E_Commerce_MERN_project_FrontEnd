...
import { GetCatById } from './services/category';
...
class ProductDetails extends Component {
  ...
  async componentDidMount() {
    ...
    const category = await GetCatById(product.categoryId);
    console.log(category);
    this.setState({ product, category });
  }
  render() {
    const { name, description, data, price, discount, tags, categoryId, imagesUrls } = this.state.product;
        ...
        <div className='product-details container'>
          <section className='product-details__main'>
            ...
            <div className='product-details__info'>
              ...
              <div className='product-details__amount'>${discount ? price - discount : price}</div>
            ...
            <div className='item-listing__items item-listing--4items'>
              ...
              <div className='item-medium-1'>
                <div
                  ...
                  style={{ backgroundImage: 'url(img/products/product-grey-7.jpg)' }}
                >
